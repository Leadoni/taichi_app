...
(function () {
  ...
  const GUIDES = [
    { id:"joint-mobility", cover:"https://pixtozeghxwiidpnloih.supabase.co/storage/v1/object/public/recipe-images/guides/joint-mobility.jpg?v=3", title:"Joint & Mobility", sub:"Gentle seated joint-care routine", file:"assets/guide-joint-mobility.pdf?v=1", group:"essentials", offer:"guide_joint-mobility", unlock:["essential_guides","essential_guides_onetime","guide_joint-mobility"], ready:true },
    { id:"breathing", cover:"https://pixtozeghxwiidpnloih.supabase.co/storage/v1/object/public/recipe-images/guides/breathing.jpg?v=3", title:"Stress-Relief Breathing", sub:"Seated breathing to calm body & mind", file:"assets/guide-breathing.pdf?v=2", group:"essentials", offer:"guide_breathing", unlock:["essential_guides","essential_guides_onetime","guide_breathing"], ready:true },
    { id:"nutrition", cover:"https://pixtozeghxwiidpnloih.supabase.co/storage/v1/object/public/recipe-images/guides/nutrition.jpg?v=3", title:"Weekly Gentle Nutrition", sub:"7 gentle habits for eating well", file:"assets/guide-nutrition.pdf?v=1", group:"essentials", offer:"guide_nutrition", unlock:["essential_guides","essential_guides_onetime","guide_nutrition"], ready:true },
    { id:"desserts", cover:"https://pixtozeghxwiidpnloih.supabase.co/storage/v1/object/public/recipe-images/guides/desserts.jpg?v=3", title:"Sweet & Gentle: 25 Lighter Desserts", sub:"25 lighter treats you'll love", file:"assets/guide-desserts.pdf?v=1", group:"essentials", offer:"guide_desserts", unlock:["essential_guides","essential_guides_onetime","guide_desserts"], ready:true },
    { id:"sleep", cover:"https://pixtozeghxwiidpnloih.supabase.co/storage/v1/object/public/recipe-images/guides/sleep.jpg?v=3", title:"Better Sleep", sub:"A Chair Tai Chi wind-down for restful nights", file:"assets/guide-sleep.pdf?v=1", group:"wellbeing", offer:"guide_sleep", unlock:["all_guides","guide_sleep"], ready:true },
    { id:"eating", cover:"https://pixtozeghxwiidpnloih.supabase.co/storage/v1/object/public/recipe-images/guides/eating.jpg?v=3", title:"Eating Without Guilt", sub:"A calm, kind relationship with food", file:"assets/guide-eating.pdf?v=1", group:"wellbeing", offer:"guide_eating", unlock:["all_guides","guide_eating"], ready:true },
    { id:"aging", cover:"https://pixtozeghxwiidpnloih.supabase.co/storage/v1/object/public/recipe-images/guides/aging.jpg?v=3", title:"Aging Gracefully", sub:"7 pillars for a strong, calm, joyful later life", file:"assets/guide-aging.pdf?v=1", group:"wellbeing", offer:"guide_aging", unlock:["all_guides","guide_aging"], ready:true },
  ];
  const GROUPS = [
  ...
  function vExercises(tab) {
    ...
    // First visit: show the welcome card ONLY. Once seen/closed: show the compact button instead.
  ...
  function vTrack(metric) {
    ...
    const input = metric === "water"
      ? `<div class="tapsel glasses" id="tapsel">${Array.from({length:8},(_,i)=>`<button data-v="${i+1}" aria-label="${i+1} glasses"><span class="n">${i+1}</span><span class="g">💧</span></button>`).join("")}</div>`
      : metric === "balance"
